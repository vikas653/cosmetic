...
<!-- Mirrored from htmldemo.net/theface/theface-v3/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Apr 2025 11:18:13 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>About Us || Theface</title>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="about-us-img-wrapper mb-30 mb-xs-15">
                            ...
                            <a href="#"><img src="<?= base_url('assets/images/about/about-1.jpg'); ?>" alt="About Image"></a>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="single-team mb-30">
                            <div class="team-image img-full">
                                <a href="#"><img src="<?= base_url('assets/images/team/team-1.jpg');?>" alt=""></a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="single-team mb-30">
                            <div class="team-image img-full">
                                <a href="#"><img src="<?= base_url('assets/images/team/team-2.jpg')?>" alt=""></a>
                            </div>
                            <div class="team-content">
                                <div class="team-hover-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="single-team mb-30">
                            <div class="team-image img-full">
                                <a href="#"><img src=
                                "<?= base_url('assets/images/team/team-3.jpg')?>" alt=""></a>
                            </div>
                            <div class="team-content">
                                <div class="team-hover-info">
            ...
            <div class="container">
                <div class="row tf-element-carousel" data-slick-options='{
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-image">
                                <img src=
                                "<?= base_url('assets/images/author/test-author-1.png')?>" alt="">
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-image">
                                <img src= "<?= base_url('assets/images/author/test-author-2.png')?>" alt="">
                            </div>
                            <div class="testimonial-content">
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-image">
                                <img src= "<?= base_url('assets/images/author/test-author-3.png')?>" alt="">
                            </div>
                            <div class="testimonial-content">
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-image">
                                <img src= "<?= base_url('assets/images/author/test-author-4.png')?>" alt="">
                            </div>
                            <div class="testimonial-content">
                                <p class="author-desc">  All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you ! ..</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-image">
                                <img src= "<?= base_url('assets/images/author/test-author-5.png')?>" alt="">
                            </div>
                            <div class="testimonial-content">
                                <p class="author-desc">  All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you ! ..</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="brand-slider p-0 tf-element-carousel section" data-slick-options='{
                        ...
                        <div class="brand col"><a href="#"><img src="<?= base_url('assets/images/brands/brand-1.png')?>" alt=""></a></div>
                        <div class="brand col"><a href="#"><img src="<?= base_url('assets/images/brands/brand-2.png')?>" alt=""></a></div>
                        <div class="brand col"><a href="#"><img src="<?= base_url('assets/images/brands/brand-3.png')?>" alt=""></a></div>
                        <div class="brand col"><a href="#"><img src="<?= base_url('assets/images/brands/brand-4.png')?>" alt=""></a></div>
                        <div class="brand col"><a href="#"><img src="<?= base_url('assets/images/brands/brand-5.png')?>" alt=""></a></div>
                    </div>
                    <!--Brand Slider end-->
...
<!-- Mirrored from htmldemo.net/theface/theface-v3/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Apr 2025 11:18:27 GMT -->
</html>