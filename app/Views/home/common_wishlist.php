                                        ...
                                        if (count($products) > 0) {
                                            foreach ($products as $product) {
                                                ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><a href="<?php echo base_url(); ?>home/productbyid/<?php echo $product["product_id"]; ?>"><?php echo $product["product_title"] ?></a></td>
                                                    <td>₹<?php echo $product["product_price"] + $product["tax"] ?></td>
                                                    <td>
