                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">All Professionals</h3>
                                ...
                                <tbody>
                                    ...
                                    foreach ($professionals as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                             if($row["professional_activation"] == 0)
                                                 echo "<i class='btn btn-danger btn-xs'>Inactive</i>";
                                             else
                                                 echo "<i class='btn btn-success btn-xs'>Active</i>";
                                            ?></td>
                                            <td>
                                                <a href="<?php echo base_url("dashboard/reviewProfessional/" . $row["id"]) ?>" class="btn btn-info btn-sm">Review Account</a>
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
